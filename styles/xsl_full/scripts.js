...
if(document.getElementById('advanced-search')) {
	document.getElementById('advanced-search').onclick = function(){
		...
		if (settings.style.display != 'block'){
			setCookie('filter', 'visible');
			settings.style.display = 'block';
			this.style.backgroundImage = 'url(/images/cms/admin/full/tree/minus.gif)';
		} else {
			setCookie('filter', 'hide');
			settings.style.display = 'none';
			this.style.backgroundImage = 'url(/images/cms/admin/full/tree/plus.gif)';	
		}
	} 
}
