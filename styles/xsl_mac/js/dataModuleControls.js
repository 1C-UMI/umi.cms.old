...
//		objLineControls.innerHTML = "<a href='/admin/data/type_field_add/" + id + "/" + this.type_id + "/'><img src='/images/cms/admin/full/ico_add.gif' border='0' /></a>&nbsp;&nbsp;<a href='/admin/data/type_group_edit/" + id + "/" + this.type_id + "/'><img src='/images/cms/admin/full/tree/ico_edit.gif' border='0' /></a>&nbsp;&nbsp;<a href='#' onclick='javascript: data_blocks.get().deleteGroup(" + id + "); return false;'><img src='/images/cms/admin/full/ico_del.gif' border='0' /></a>";
		if(group[4] == 1) {
			...
			objLineControls.innerHTML = "<a href='/admin/data/type_group_edit/" + id + "/" + this.type_id + "/'><img src='/images/cms/admin/mac/tree/ico_edit.gif' border='0' /></a>&nbsp;&nbsp;<a href='#' onclick='javascript: data_blocks.get().deleteGroup(" + id + "); return false;'><img src='/images/cms/admin/mac/tree/ico_del.gif' border='0' /></a>";
		}
		...
		if(group[4] == 0) {
			objAddButton.innerHTML = "<table><tr><td valign='middle'><a href='/admin/data/type_field_add/" + id + "/" + this.type_id + "/'><img src='/images/cms/admin/mac/ico_data_add_field.gif' border='0' /></a></td><td valign='middle'>&nbsp;<a href='/admin/data/type_field_add/" + id + "/" + this.type_id + "/'>Добавить поле</a></td></tr></table>";
		}
...
data_blocks.prototype.preRenderField = function (id) {
	...
	if(field[7] == 1) {
		...
		objLineControls.innerHTML = "<a href='/admin/data/type_field_edit/" + id + "/" + field[5] + "/'><img src='/images/cms/admin/mac/tree/ico_edit.gif' border='0' /></a>&nbsp;&nbsp;<a href='#' onclick='javascript: data_blocks.get().deleteField(" + id + "); return false;'><img src='/images/cms/admin/mac/tree/ico_del.gif' border='0' /></a>";
	}
	objLine.appendChild(objLineControls);
