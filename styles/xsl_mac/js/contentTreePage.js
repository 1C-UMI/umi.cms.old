...
contentTreePage.prototype.draw = function (placer, nextPage, parentDomain) {
	...
	//setting ico
	icoObj.style.backgroundImage = "url('/images/cms/admin/mac/tree/ico_" + this.module + "_" + this.method + ".gif')";
...
//	containerObj.appendChild(separatorObj);
	...
	buttonObj.style.backgroundImage = "url('/images/cms/admin/mac/tree/ico_del.gif')";
	...
	buttonObj.className = "contentTreePageControlsButton";
	if(this.add_link) {
		buttonObj.style.backgroundImage = "url('/images/cms/admin/mac/tree/ico_add.gif')";
	...
	if(this.edit_link) {
		buttonObj.style.backgroundImage = "url('/images/cms/admin/mac/tree/ico_edit.gif')";
	...
	isActiveButtonObj.style.backgroundImage = (this.is_active) ? ("url('/images/cms/admin/mac/ico_unblock.gif')") : ("url('/images/cms/admin/mac/ico_block.gif')");
	...
	buttonObj.className = "contentTreePageControlsButton";
	buttonObj.style.backgroundImage = "url('/images/cms/admin/mac/tree/copy.gif')";
	...
	if(this.childs_count > 0) {
		buttonObj.onclick = function () {
			...
			html += "Если вы хотите сделать копию только этой страницы, нажмите 'Только эту страницы'.<br />";
	...
	var buttonObj = document.createElement("div");
	buttonObj.className = "contentTreePageControlsButton";
	buttonObj.style.backgroundImage = "url('/images/cms/admin/mac/tree/clone.gif')";
	...
	var buttonObj = document.createElement("a");
	buttonObj.className = "contentTreePageControlsButton";
	buttonObj.style.backgroundImage = "url('/images/cms/admin/mac/tree/view.gif')";
...
contentTreePage.prototype.setIsActive = function (mode) {
	...
	this.isActiveButtonObj.style.backgroundImage = (this.is_active) ? ("url('/images/cms/admin/mac/ico_unblock.gif')") : ("url('/images/cms/admin/mac/ico_block.gif')");
