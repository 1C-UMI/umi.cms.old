<?php
	abstract class __albums_add_photoalbum {
...
END;
			...
			if(cmsController::getInstance()->getModule('users')) {
				$params['perm_panel'] = cmsController::getInstance()->getModule('users')->get_perm_panel("photoalbum", "view", "album_edit");
			}
			...
			$params['albom_users'] = putSelectBox_assoc(umiObjectsCollection::getInstance()->getGuidedItems($user_object_type), cmsController::getInstance()->getModule("users")->user_id, false);
			...
			$params['method'] = "album_add_do";
			return $this->parse_form("album_add", $params);
		}



		public function album_add_do() {
