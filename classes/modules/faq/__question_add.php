...
abstract class __faq_question_add {
	public function question_add() {
		...
		$this->navibar_back();
		$this->navibar_push($parent->getName(), "/admin/faq/questions_list/" . $parent_id);
		$this->navibar_push("%nav_question_add%");
		...
		if(cmsController::getInstance()->getModule('users')) {
			$files_panel = cmsController::getInstance()->getModule('users')->get_perm_panel_adding("faq", Array("questions_list", "question_add"));
		...
		if(cmsController::getInstance()->getModule('data')) {
			$type_id = umiObjectTypesCollection::getInstance()->getBaseType("faq", "question");
		...
		if(cmsController::getInstance()->getModule('users')) {
			$params['perm_panel'] = cmsController::getInstance()->getModule('users')->get_perm_panel("faq", "question", "question_add");
		}
	...
	public function question_add_do() {
