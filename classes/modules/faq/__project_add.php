...
abstract class __faq_project_add {
	public function project_add() {
		...
		if(cmsController::getInstance()->getModule('users')) {
			$files_panel = cmsController::getInstance()->getModule('users')->get_perm_panel_adding("faq", Array("projects_list", "project_add"));
		...
		if(cmsController::getInstance()->getModule('data')) {
			$type_id = umiObjectTypesCollection::getInstance()->getBaseType("faq", "project");
		...
		if(cmsController::getInstance()->getModule('users')) {
			$params['perm_panel'] = cmsController::getInstance()->getModule('users')->get_perm_panel("faq", "project", "project_add");
		}
