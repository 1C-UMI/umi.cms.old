			...
			<table border="0" width="100%" cellspacing="0" cellpadding="0">
				...
				<tr>
					<td colspan="2">
						<p />
						Комментарии<br />
						<textarea name="banner_desc" style="width: 99%; height: 56px;">%banner_desc%</textarea>
					</td>
				</tr>
			</table>
